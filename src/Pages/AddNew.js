...
class AddNew extends React.Component {
   constructor(props) {
    ...
    this.handleChangeContains1 = this.handleChangeContains1.bind(this);
    this.handleChangeContains2 = this.handleChangeContains2.bind(this);
    this.handleChangeContains3 = this.handleChangeContains3.bind(this);
